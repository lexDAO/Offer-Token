 ...
 * the owner.
 */
contract PayableOwnable is Context {
...
contract OfferToken is LexDAORole, PayableOwnable, ERC20Burnable, ERC20Capped {
    using SafeMath for uint256;
    ...
    ***************/
    ...
    constructor(
        ...
        _transferOwnership(_offeror); // offeror is initial owner of OfferToken 
    }
